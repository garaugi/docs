...
1.  In the **Database Type** section:
    ...
    1.  Select the type of Postgres you want to use in the **Postgres Type** field:
        ...
        <FeatureFlag flagName="prod-in-preview">
        -   **PostgreSQL Compatible** is powered by [EDB Postgres Extended Server](/pge/latest/), which uses uses advanced logical replication of data and schema. It is only available if you select extreme high availability as your cluster type.
         </FeatureFlag> 
